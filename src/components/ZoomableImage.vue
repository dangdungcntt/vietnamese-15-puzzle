...
<template>
    <div @click="toggleZoomIn" style="position:relative;display:flex;flex-direction:column;cursor:pointer;"
        :style="style">
        <div
            :style="`flex-grow:1;background-position:center ${isZoomIn ? 'center' : 'bottom'};background-repeat:no-repeat;background-size:contain;background-image:url(${placeholder})`">
        </div>
